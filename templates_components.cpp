...
/*
   ...
   find(first_iterator, last_iterator, x) – Returns an: iterator to the first occurence of x in vector and 
   ...
   lower_bound(first_iterator, last_iterator, x) – returns an iterator pointing to 
    ...
    upper_bound(first_iterator, last_iterator, x) – returns an iterator 
         pointing to the first element in the range [first,last)  which has a value greater than ‘x’.     
