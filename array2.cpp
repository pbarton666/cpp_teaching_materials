...
int main(){
    // Syntax:
    // vector<type_of_elements_contained>  name;

    // vector doesn't return anything (it's void).  holds homogenous objects
    // but ... it's flexiblely-sized, and it knows how big it is
